...
def map_user_plot_3(df, states):
    ...
    with col2:
        ...
        fig_map_user_bar_2= px.bar(muyqs, x= "AppOpens", y= "Districts", orientation= "h",
                                title= f"{states.upper()} APPOPENS", height= 800, color_discrete_sequence= px.colors.sequential.Greens_r)
...
#plot_3
    ...
    fig_count_3= px.bar(df_3, y="states", x="transaction_count", title= "AVERAGE OF TRANSACTION COUNT", hover_name= "states", orientation= "h",
...
if select == "HOME":
    ...
    with col1:
        ...
        st.markdown("""📱 PhonePe is a top UPI app used for fast money transfers 💸,  
                       bill payments, QR payments 🏪, and financial services 🛡️📊.  
                       Its Pulse dataset shows India’s digital payment growth 🇮🇳.""")
        st.markdown("""📱 PhonePe was founded in **2015** as a digital payments platform, and became one of India’s leading UPI apps after UPI launched in 2016.  
                    🌍 Today, it powers **billions of transactions**, enabling fast, secure, bank-to-bank payments across the country.
                    """)
        st.markdown("""
### 📱Features  
💸 Instant UPI • 📱 Scan & Pay • 🔐 Secure PIN • 🧾 Bills/Recharges • 🛡 Insurance • 🌍 State Insights
""")

        st.download_button("DOWNLOAD THE APP NOW", "https://www.phonepe.com/app-download/")
    with col2:
        st.video(r"C:\Users\abith\OneDrive\Desktop\New folder\pulse-video.mp4", start_time=0)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\abith\OneDrive\Desktop\New folder\Picsart_25-11-29_19-59-35-344.png"), width= 700)

    with col4:
        st.markdown("""### 📊 PhonePe Pulse Dataset  
📌 India’s open digital payments dataset with **state & district-wise UPI insights**.  
🔢 Includes **transaction count/value**, 👤 **user adoption**, 📱 **app opens**,  
🛡️ **insurance trends**, covering 🇮🇳 **36 states**, 700+ districts, from **2018–2023**.  
📦 Provided in easy-to-use **JSON format** for dashboards & analytics.
""")
    ...
    with col5:
        ...
        st.markdown("""
### 📱 PhonePe Usage  
📱 PhonePe makes digital payments simple and instant — **no wallet top-up needed**.  
🏦 Pay **directly from any bank account** using UPI, send money to friends, family, or merchants in seconds.  
💳 Scan & Pay at any shop across India using **any UPI QR code** effortlessly.  
📡 Recharge mobiles, DTH, FASTag and pay electricity, gas, water & broadband bills with a single tap.  
🔐 Every transaction is protected with **UPI PIN, multi-layer security**, and real-time fraud checks.  
⚡ Enjoy **fast, secure, and 100% free** payments — anytime, anywhere.  
""")


    with col6:
        st.video(r"C:\Users\abith\OneDrive\Desktop\New folder\upi.mp4", start_time=0)

# 3D Feature Boxes (simple + no error)
    ...
    <div style="
        ...
        text-align:center;color:#eedbff;
        border:1px solid rgba(180,120,255,0.3);
        box-shadow:0 0 15px rgba(150,80,255,0.3);
    ">
...
# Footer
    ...
    st.markdown(
    "<div style='text-align:center;color:#cdbbff;'>🧑‍💻 Designed by <b>Abitha Jesuraj</b> • PhonePe Transaction</div>",
    unsafe_allow_html=True
)
    ...
    with tab3:  
        ...
        if method_3 == "Top Insurance":
            ...
            with col1:
                ...
                quarters= st.slider("Select The Quarter_TQ", Top_insur_tac_Y["Quarter"].min(), Top_insur_tac_Y["Quarter"].max(), Top_insur_tac_Y["Quarter"].min())
